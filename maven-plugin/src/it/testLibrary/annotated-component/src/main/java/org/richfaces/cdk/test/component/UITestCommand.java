...
public class UITestCommand extends UIComponentBase implements ActionSource2 {
     ...
     * (non-Javadoc)
     *
     * @see jakarta.faces.component.ActionSource2#getActionExpression()
     */
     ...
     * (non-Javadoc)
     *
     * @see jakarta.faces.component.ActionSource2#setActionExpression(jakarta.el.MethodExpression)
     */
